<template>
	<div class='pdajhzyck'>
			...
			<!--form第一行-->
				...
				<el-row :gutter="10">
					...
					<el-col :span="2">
						...
						<p style="text-align:right">收货作业单号:</p>
						</div>
					</el-col>
					<el-col :span="3">
						<div class="grid-content ">
							<el-input    v-model='djbh'  class='input_width' disabled></el-input>
						</div>
					</el-col>
					<el-col :span="2">
						<div class="grid-content ">
						<p style="text-align:right">单据日期：</p> </div>
					</el-col>
					<el-col :span="3">
						<div class="grid-content ">
							<el-input    v-model='djrq'  class='input_width' disabled></el-input>
						</div>
					</el-col>
					<el-col :span="2">
						<div class="grid-content ">
							<p style="text-align:right">制单人：</p>
						</div>
					</el-col>
					<el-col :span="3">
						<div class="grid-content ">
        ...
        <el-row :gutter="10">
					<el-col :span="2">
						<div class="grid-content ">
						<p style="text-align:right">仓库：</p>
						</div>
					</el-col>
					<el-col :span="3">
						<div class="grid-content ">
							<el-input    v-model='cangku'  class='input_width' disabled></el-input>
						</div>
					</el-col>
				</el-row>
			<!--form第二行-->
		...
		<div class='table'>
			<div class='button_row'>
				...
				<el-tabs type="border-card" v-model="activeName" >
					<el-tab-pane label="订单明细" name='ddmx'>
						<div id='table_hz'>
							<div class="table_right">
								<el-table :data="ddmx" @header-click="headerc1" height="510" class="table1" border style="width: 100%">
									...
									<el-table-column prop="PlanID" label="捡货计划单号" width="auto">
										<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									<el-table-column prop="PlanID" label="捡货作业单号" width="auto">
										<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="BillID" label="单据编号" width="120">
										<el-table-column prop="BillID" label="" width="120" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="PlanID" label="序号" width="auto">
										<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									...
									<el-table-column prop="ProductionDate" label="生产日期" width="120">
										<el-table-column prop="ProductionDate" label="" width="120" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									...
									<el-table-column prop="Account1" label="托盘号" width="150">
										<el-table-column prop="Account1" label="" width="150" class-name="mohucha">
										</el-table-column>
									</el-table-column>

									<el-table-column prop="ReceiveNum" label="已拣基本数量" width="auto">
										<el-table-column prop="ReceiveNum" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="ReceiveSupNum" label="已拣辅助数量" width="auto">
										<el-table-column prop="ReceiveSupNum" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="SupNum" label="仓位" width="auto">
										<el-table-column prop="SupNum" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="ShelvesNum" label="仓库" width="auto">
										<el-table-column prop="ShelvesNum" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									<el-table-column prop="PlanID" label="缺货" width="auto">
										<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									<el-table-column prop="PlanID" label="缺货新增" width="auto">
										<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									<el-table-column prop="PlanID" label="差异数" width="auto">
										<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
								</el-table>
					...
					<el-tab-pane label="汇总明细" name='hzmx'>
						<div id="table_ls">
							<div class="table_right">
								<el-table :data="hzmx" height="510" @header-click="headerc" class="table" border style="width: 100%" >
									<el-table-column type='index' prop="" label="" width="50">
									  <el-table-column type='index' prop="" label="" width="50">
									  </el-table-column>
									</el-table-column>
									...
									<el-table-column prop="ProID" label="商品编号" width="auto">
										<el-table-column prop="ProID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									...
									<el-table-column prop="EffectiveDate" label="有效期至" width="150">
										<el-table-column prop="EffectiveDate" label="" width="150" class-name="mohucha">
										</el-table-column>
									</el-table-column>
			...
			<!--修改价格弹窗-->
			<el-dialog :title="'收货计划单-修改价格-'+djbh" class="xgjg" :visible.sync="xgjg_Click" size="tiny" :before-close="handleClose">
				<xgjg :djrq="djrq" :planid="djbh" :ddmx="ddmx" :zdr="zdr"></xgjg>
			</el-dialog>
			<!--修改价格弹窗 end-->
...
<script>
	...
	export default {
		...
		mounted: function() {
			var that = this;
			var getInfo = window.localStorage.getItem("jhzyPickID");
			that.djbh = getInfo;//存放单据
			// 获取数据
			that.lookList(getInfo);
		},
		methods: {
			handleClose(done) {
				this.$confirm('确认关闭？')
			...
			headerc1: function(column, event) {
				...
				var data = column.property; //需要匹配的标识
				var index = $dom.parent().index(); //列坐标,用来匹配用
				var $datath = $("th.mohucha", $(".table1")); //匹配行Th
				var $table = $($(".table1 table")[1]); //表格(表格控件会生成两表格,所以此处要筛选数据的表格是第二个)
			...
			lookList (planID){
				...
				$.ajax({
					...
					success: function(data, textStatus, jqXHR) {
						...
						var data = datas.Data;
						that.splbs = data;
						that.djrq = that.splbs[0].Date; //日期
						that.zdr = that.splbs[0].Poster; //制单人
						that.hzmx = that.splbs[0].SumPro; //汇总明细
						that.ddmx = that.splbs[0].BillPro; //订单明细
						// 把拣货单号与商品单据放进
						that.hzmx.forEach((item,index)=>{
							that.$set(that.hzmx[index],"PlanID",that.djbh);
						});
						that.ddmx.forEach((item,index)=>{
