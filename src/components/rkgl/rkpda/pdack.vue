	...
	<div class='rkddzhbb' id='rkddzhbb'>
		...
		<div class="searchnav">
			<!--form第一行-->
				...
				<el-row :gutter="10">
					...
					<el-col :span="2">
						<div class="grid-content ">
						 <el-button @click="editPrice">修改价格</el-button>
						</div>
					</el-col>
				</el-row>
			<!--form第二行-->
		...
		<div class='table'>
						...
						<div id='table_hz'>
							<div class="table_right">
								<el-table :data="ddmx" @header-click="headerc1" height="510" class="table1" border style="width: 100%">
									...
									<el-table-column prop="BillID" label="单据单号" width="auto">
										<el-table-column prop="BillID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									<el-table-column prop="BillEntryID" label="序号" width="auto">
										<el-table-column prop="BillEntryID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									<el-table-column prop="BillType" label="单据类型" width="auto">
										<el-table-column prop="BillType" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
			...
			<el-dialog :title="'收货计划单-修改价格-'+djbh" class="xgjg" :visible.sync="xgjg_Click" size="tiny" :before-close="handleClose">
				<xgjg :djrq="djrq" :planid="djbh" :ddmx="ddmx" :zdr="zdr">
					<div slot="xgjgClose" class="curbox tc" @click="xgjg_Click = false">
							<span>退出</span>
						</div>
				</xgjg>
...
<script>
	...
	export default {
		...
		mounted: function() {
			var that = this;
			var getInfo = window.localStorage.getItem("dataPlanID");
