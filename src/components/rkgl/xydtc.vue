	...
	<div class='xydtc'>
		...
		<div class='search'>
			<el-row :gutter="20">
				...
				<el-col :span="4">
					<div class="grid-content ">
						<p>共计：
							<span style="color: red;">{{YDtableData.length}}</span>条记录</p>
					</div>
				</el-col>
			</el-row>
		</div>
		...
		<div class='tc_table'>
			<el-table :data="YDtableData" highlight-current-row border height='300' style="width: 100%" @header-click="headerc" @cell-dblclick="dbrow" >
				...
				<el-table-column prop="StorageDate" label="日期" width="80">
					<el-table-column prop="StorageDate" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="StorageID" label="单据编号" width="80">
					<el-table-column prop="StorageID" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="BillNum" label="源单号" width="80">
					<el-table-column prop="BillNum" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="Type" label="入库类型" width="80">
					<el-table-column prop="Type" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="SupplierName" label="供应商" width="80">
					<el-table-column prop="SupplierName" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="Total" label="单据金额" width="80">
					<el-table-column prop="Total" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="合同编号" width="80">
					<el-table-column prop="zip" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="SalesMan" label="业务员" width="80">
					<el-table-column prop="SalesMan" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="Delivery" label="交货方式" width="80">
					<el-table-column prop="Delivery" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="ArrivalTime" label="预计到达时间" width="80">
					<el-table-column prop="ArrivalTime" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="Checker" label="审核人" width="80">
					<el-table-column prop="Checker" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="Poster" label="制单人" width="80">
					<el-table-column prop="Poster" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="CheckDate" label="审核时间" width="80">
					<el-table-column prop="CheckDate" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="Remarks" label="备注" width="80">
					<el-table-column prop="Remarks" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
				<el-table-column prop="DeptName" label="部门" width="80">
					<el-table-column prop="DeptName" label="" width="80" class-name="mohucha">
				  </el-table-column>
				</el-table-column>
			</el-table>
  ...
  watch: {
    ...
    getxydList () {
        ...
        StartDate: Start || that.ksrq,
				...
				SupplierID: that.dataInfo.gysid || 0,
			...
			$.ajax({
				...
				data: {
					datas: params,
					method: "CPHH.PC.StorageModule.Storage.SelectOrder"
				},
				timeout: 5000, //超时时间
