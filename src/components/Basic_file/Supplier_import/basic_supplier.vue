	...
	<div class='supplier'>
		<div class="but-box">
			<ul>
				<li>
					<div class="boxtab">
						<div class="curbox tianjia " @click='gysAdd=true'>
							<span>添加</span>
						</div>
					</div>
					<div class="boxtab">
						<div class="curbox bj" @click='gysbj=true'>
							<span>编辑</span>
						</div>
					</div>
					<span class="gun"></span>
				...
				<li>
					...
					<div class="boxtab">
						<div class="curbox fjy" @click='fjy_Click=true'>
							<span>反禁用</span>
						</div>
					</div>
		...
		<div class='main_table'>
			...
			<div class='right'>
				<div class='heji'>
					<span><p>[供应商]</p>的内容，---------共计<p>0</p>条记录</span>
				</div>
				<el-table ref="multipleTable" :data="khlist" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中" border tooltip-effect="dark" style="width: 100% " height="700" @selection-change="handleSelectionChange">
					...
					<el-table-column prop="Name" label="默认" width="160">
						<el-table-column prop="Name" label="" width="160" class-name="mohucha">
						</el-table-column>
					</el-table-column>
