<template>
	<div class='pdafhzyck' id='pdafhzyck'>
		<!--出库管理综合报表-->
		<div class="but-box">
			<ul>
				<li>
		...
		<div class='table'>
			<div class='button_row'>
				...
				<el-tabs type="border-card" v-model="activeName" >
					<el-tab-pane label="单据明细" name='hzmx'>
								<el-table :data="djmx" height="510" @header-click="headerc" class="table" border style="width: 100%" >
									<el-table-column type='index' prop="" label="" width="50">
									  <el-table-column type='index' prop="" label="" width="50">
									  </el-table-column>
									</el-table-column>
									<el-table-column prop="PlanID" label="计划单号" width="auto">
										<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="ProName" label="商品编号" width="auto">
										<el-table-column prop="ProName" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="ProModel" label="商品名称" width="220">
										<el-table-column prop="ProModel" label="" width="220"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="Unit" label="规格型号" width="auto">
										<el-table-column prop="Unit" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="SupUnit" label="基本单位" width="auto">
									...
									<el-table-column prop="Num" label="复核基本数量" width="auto">
										<el-table-column prop="Num" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="SupNum" label="复核辅助数量" width="auto">
										<el-table-column prop="SupNum" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="SupNum" label="出库单号" width="auto">
										<el-table-column prop="SupNum" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>

									<el-table-column prop="SupNum" label="容器" width="auto"> <el-table-column prop="SupNum" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
								</el-table>
					</el-tab-pane>
...
<script>
	export default {
		...
		mounted: function() {
			var that = this;
			var getInfo = window.localStorage.getItem("fhzyBill");
