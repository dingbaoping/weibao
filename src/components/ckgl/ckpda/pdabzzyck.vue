			...
			<!--form第一行-->
				...
				<el-row :gutter="10">
					...
					<el-col :span="2">
						...
						<p style="text-align:right">播种作业单号：</p>
						</div>
					</el-col>
					<el-col :span="3">
						<div class="grid-content ">
		...
		<div class='table'>
			<div class='button_row'>
				...
				<el-tabs type="border-card" v-model="activeName" >
					<el-tab-pane label="作业明细" name='hzmx'>
								<el-table :data="djmx" height="510" @header-click="headerc" class="table" border style="width: 100%" >
									...
									<el-table-column prop="ProCode" label="播种作业单号" width="auto">
...
<script>
	export default {
		...
		mounted: function() {
			var that = this;
			var getInfo = window.localStorage.getItem("bzzyBill");
