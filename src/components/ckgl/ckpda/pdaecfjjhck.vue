	...
	<div class='rkddzhbb' id='rkddzhbb'>
		...
		<div class='table'>
			<div class='button_row'>
				...
				<el-tabs type="border-card" v-model="activeName" >
					<el-tab-pane label="单据明细" name='hzmx'>
								<el-table :data="hzmx" height="510" @header-click="headerc" class="table" border style="width: 100%" >
									...
									<el-table-column prop="Num" label="已拣基本数量" width="auto">
										<el-table-column prop="Num" label="" width="auto"  class-name="mohucha">
								    </el-table-column>
									</el-table-column>
									<el-table-column prop="SupNum" label="已拣辅助数量" width="auto">
				...
				<el-tab-pane label="单据容器" name='djrq'>
						<el-table :data="djrq" height="510" @header-click="headerc" class="table" border style="width: 100%" >
								<el-table-column type='index' prop="" label="" width="50">
									<el-table-column type='index' prop="" label="" width="50">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="PlanID" label="出库单号" width="160">
									<el-table-column prop="PlanID" label="" width="auto"  class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="ProCode" label="容器条码" width="160">
									<el-table-column prop="ProCode" label="" width="auto"  class-name="mohucha">
									</el-table-column>
								</el-table-column>
							</el-table>
				...
				<el-tab-pane label="单据列表" name='djlb'>
						<el-table :data="djlb" height="510" @header-click="headerc" class="table" border style="width: 100%" >
								<el-table-column type='index' prop="" label="" width="50">
									<el-table-column type='index' prop="" label="" width="50">
									</el-table-column>
								</el-table-column>
...
<script>
	export default {
		...
		mounted: function() {
			var that = this;
			var getInfo = window.localStorage.getItem("fhjhBill");
