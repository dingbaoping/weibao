<template>
	<div class='ckrgjhjhd'>
		...
		<!--表格-->
		<div class='table'>
			<el-table :data="tableData3" height="680" @cell-dblclick="dbrow" @header-click="headerc" border style="width: 100%" @selection-change="handleSelectionChange">
				<el-table-column type='selection' prop="" label="选定框" width="50">
					<el-table-column  prop="name" label="" width="50" class-name="mohucha">
								    </el-table-column>
				</el-table-column>
				<el-table-column prop="name" label="单号" width="200">
				...
				<el-table-column prop="address" label="制单时间" width="140">
					<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
								    </el-table-column>
				</el-table-column>
				<el-table-column prop="address" label="配送中心" width="140">
					<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
								    </el-table-column>
				</el-table-column>
				<el-table-column prop="address" label="园区" width="140">
					<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
								    </el-table-column>
				</el-table-column>
...
.ckrgjhjhd .el-form-item__content {
	margin-top: 6px;
	margin-left: 10px;
}

.ckrgjhjhd .el-table th>.cell {
	line-height: normal;
}
