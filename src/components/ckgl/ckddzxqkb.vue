	...
	<div class='ckddzhqkb' id='ckddzhqkb'>
		...
		<div class='table'>
			<div class='button_row'>
						<div id='table_dj'>
							<el-table :data="tableData3" height="590" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中"  border style="width: 100%">
							  ...
							  <el-table-column prop="MC" width="auto">
								  ...
								  <el-table-column prop="IsClose" label="关闭标志" width="110">
								  ...
								  <el-table-column prop="OutDate" label="订单日期" width="220">
										<el-table-column  prop="OutDate" label="" width="auto" class-name="mohucha">
								    </el-table-column>
								  </el-table-column>
								  <el-table-column prop="OutID" label="订单编号" width="110">
						      ...
						      <el-table-column prop="Type" label="出库类型" width="auto">
                				...
                				<el-table-column prop="MC" label="签订">
								  ...
								  <el-table-column prop="SupportNum" label="辅助数量" width="200">
										<el-table-column  prop="SupportNum" label="" width="200" class-name="mohucha">
								    </el-table-column>
								  </el-table-column>
								<el-table-column prop="Price" label="单价" width="200">
										<el-table-column  prop="Price" label="" width="200" class-name="mohucha">
								    </el-table-column>
								  </el-table-column>
								...
								<el-table-column prop="MC" label="未出库">
								...
								<el-table-column prop="MC" label="出库">
		...
		<div class='tongji'>
			...
			<el-tag class='tag1'><span>签订基本数量合计:{{ NumTotal }}</span></el-tag>
			<el-tag class='tag1'><span>签订辅助数量合计:{{ SupportNumTotal }}</span></el-tag>
			<el-tag class='tag2'><span>未出库基本数量合计:{{ LeftNumTotal }}</span></el-tag>
			<el-tag class='tag2'><span>未出库辅助数量合计:{{ LeftSupportNumTotal }}</span></el-tag>
			<el-tag class='tag2'><span>出库基本数量合计:{{ YYNumTotal }}</span></el-tag>
			<el-tag class='tag2'><span>出库辅助数量合计:{{ YYSupportNumTotal }}</span></el-tag>
	...
	export default {
      ...
      // 表格双击 (可编辑表格)
        ...
        for( let i = 0; i < data.length; i++ ) {
           ...
           YYNumTotal += data[i].YYNum;
           YYSupportNumTotal += data[i].YYSupportNum;
           LeftNumTotal += parseFloat(data[i].LeftNum);
        ...
        that.YYNumTotal = YYNumTotal;
        that.LeftSupportNumTotal = LeftSupportNumTotal;
        that.LeftNumTotal = LeftNumTotal;
			},
			// 让CodeID  也成为搜索内容
		  getCode(val) {
			  if (val) { //val存在 
