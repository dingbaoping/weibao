			...
			<div class='button_row'>
				...
				<el-tabs type="border-card"  v-model="activeName">
					<el-tab-pane label="单据列表" name='djlb'>
						<div id='table_dj'>
							<el-table :data="tableData3" height="510" border style="width: 100%" v-loading.body="loading" element-loading-text="玩命加载中">
								<el-table-column type='selection' prop="" label="选定框" width="50">
								</el-table-column>
								<el-table-column prop="djjb" label="单据级别" width="110">
								</el-table-column>
								<el-table-column prop="CloseMark" label="关闭标志" width="110">
								</el-table-column>
								<el-table-column prop="CheckMark" label="审核标志" width="110">
								</el-table-column>
								<el-table-column prop="SubmitStatus" label="单据编号" width="110">
								</el-table-column>
								<el-table-column prop="StorageID" label="提交状态" width="110">
								</el-table-column>
								<el-table-column prop="StorageDate" label="出库类型" width="110">
								</el-table-column>
								<el-table-column prop="Type" label="订单日期" width="auto">
								</el-table-column>
								<el-table-column prop="CloseReason" label="客户编号" width="auto">
								</el-table-column>
								<el-table-column prop="SupplierName" label="客户名称" width="auto">
								</el-table-column>
								...
								<el-table-column prop="ArrivalTime" label="需配送时间" width="auto">
								</el-table-column>
								...
								<el-table-column prop="CloseOperator" label="实际配送时间" width="auto">
								</el-table-column>
								<el-table-column prop="ParName" label="合作方" width="auto">
								</el-table-column>
								<el-table-column prop="RMark" label="订单状态" width="auto">
								</el-table-column>
								<el-table-column prop="CloseOperatorDate" label="交货地点" width="auto">
								</el-table-column>
								<el-table-column prop="Poster" label="备注" width="auto">
								</el-table-column>
								<el-table-column prop="beizhu" label="制单人" width="auto">
								</el-table-column>
								...
								<el-table-column prop="SupportNum" label="出库状态" width="auto">
								</el-table-column>
								<el-table-column prop="DCName" label="辅助数量合计" width="auto">
								</el-table-column>
								<el-table-column prop="CreateDate" label="是否收现" width="auto">
								</el-table-column>
								<el-table-column prop="DeptName" label="配送距离" width="auto">
								</el-table-column>
								
								<el-table-column prop="Poster" label="配送中心" width="auto">
								</el-table-column>
								<el-table-column prop="beizhu" label="制单日期" width="auto">
								</el-table-column>
								<el-table-column prop="Volume" label="部门" width="auto">
								</el-table-column>
								<el-table-column prop="Weight" label="运费" width="auto">
								</el-table-column>
								<el-table-column prop="PrintNum" label="结算状态" width="auto">
								</el-table-column>
							</el-table>
						</div>
					</el-tab-pane>
					<el-tab-pane label="流水台账" name='lstz'>
						<div id="table_ls">
							...
							<div class="table_right">
								<el-table :data="tableData4" height="470" border style="width: 100%" v-loading.body="loading" element-loading-text="玩命加载中">
									<el-table-column type='selection' prop="" label="选定框" width="50">
									</el-table-column>
									...
									<el-table-column prop="StorageDate" label="单据日期" width="110">
									</el-table-column>
									<el-table-column prop="StorageDate" label="单据日期" width="110">
									</el-table-column>
					...
					<el-tab-pane label="汇总台账" name='hztz'>
						<div id='table_hz'>
							...
							<div class="table_right">
								<el-table :data="tableData5" height="470" border style="width: 100%" v-loading.body="loading" element-loading-text="玩命加载中">
									<el-table-column type='selection' prop="" label="选定框" width="50">
									</el-table-column>
									<el-table-column prop="ParName" label="合作方" width="110">
									</el-table-column>
        ...
        that.WeightTotal = weightTotal.toFixed(2);
			...
			onSearch() {
				...
				if(that.activeName == 'djlb') {
					...
					$.ajax({
						...
						data: {
							datas: jsons,
							method: "CPHH.PC.OutModule.OutOrder.BillReport",
							// test: 'test'
						},
						// timeout: 5000, //超时时间
						success: function(data, textStatus, jqXHR) {
            ...
            Close: that.gbbz
					...
					$.ajax({
						...
						data: {
							datas: jsons,
							method: "CPHH.PC.OutModule.OutOrder.ProReport"
						},
						timeout: 5000, //超时时间
						success: function(data, textStatus, jqXHR) {
							var obj = eval('(' + data + ')');
            ...
            Close: that.gbbz
					...
					$.ajax({
						...
						data: {
							datas: jsons,
							method: "CPHH.PC.OutModule.OutOrder.ProSumReport"
						},
						timeout: 5000, //超时时间
						success: function(data, textStatus, jqXHR) {
							console.log(data);
