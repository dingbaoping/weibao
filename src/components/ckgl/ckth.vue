<template>
	<div class="ckd ckth" style="position:relative">
		<form class="page2">
			...
			<el-row :gutter="10">
				...
				<el-col :span="3">
					<div class="grid-content  ">
						<div  id="ckrq">
							<el-date-picker 
								class="input_width" v-model="ckrq" align="right" type="date" placeholder="选择日期" :picker-options="pickerOptions1">
							</el-date-picker>
						</div>
		...
		<el-col :span="3">
			...
			<el-col :span="3">
				<div class="grid-content  ">
					<div><span  type="primary" class='btnzz' @click="jgfs_Click=true">加工 </span> </div>
				</div>
			</el-col>
			</el-row>
			</div>
		...
		<!-- 商品表格结束 -->
			...
			<el-dialog title="" class="hzftc" :visible.sync="hzf_Click" size="tiny" :before-close="handleClose">
				<hzftc :DCID="psData.peisong" :hzfstr="hzf" @gethzfInfo="gethzfdizhi" @checkgethzfInfo="checkgethzfInfo">
					<div slot="close" @click="hzf_Click=false" class="boxtab"><div class="curbox tc"><span>关闭</span></div></div>
				</hzftc>
			...
			<el-dialog title="" class="kehu" :visible.sync="kh_Click" size="tiny" :before-close="handleClose">
				<khtc :InterID="psData.hzfid" :khstr="kehu" @checkgetkehuInfo="checkgetkehuInfo" @getkehuInfo="getkehuInfo">
					<div slot="close" @click="kh_Click=false" class="boxtab"><div class="curbox tc"><span>关闭</span></div></div>
				</khtc>
          ...
          <div slot="jgfsClose" class="curbox tc close" @click="jgfs_Click=false">
			...
			<el-dialog title="费项" :visible.sync="fx_Click" size="tiny" :before-close="handleClose">
    			...
    			<el-button @click="fx_Click = false">取 消</el-button>
   				 <el-button type="primary" @click="fx_Click = false">确 定</el-button>
 			 </span>
			</el-dialog>
			<!-- 费项弹窗 end -->
...
<script>
	...
	export default {
      ...
      handleSelectionChange () {
			...
			lookCW () {
			var that = this;
				if( this.splbs[that.lookShopNum].Name) {
