		...
		<div class='table'>
			<div class='button_row'>
				...
				<el-tabs type="border-card" v-model="activeName">
					<el-tab-pane label="单据列表" name='djlb'>
						<div id='table_dj'>
							<el-table :data="tableData3" height="510" @cell-dblclick="dbrow" @header-click="headerc"  border style="width: 100%">
								...
								<el-table-column prop="CreateDate" label="单据日期" width="220">
								...
								<el-table-column prop="CusName" label="客户名称" width="110">
								...
								<el-table-column prop="DeliveryPerson" label="联系人" width="auto">
								...
								<el-table-column prop="ContactMobile" label="电话号码" width="auto">
								...
								<el-table-column prop="Address" label="收货地址" width="auto">
									<el-table-column prop="Address" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>

								<el-table-column prop="NeedDeliveryDate" label="需配送日期" width="auto">
								...
								<el-table-column prop="SendNo" label="配送单号" width="auto">
									<el-table-column prop="SendNo" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="CarNum" label="车牌号" width="auto">
									<el-table-column prop="CarNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="SettlementAmount" label="单据应收金额" width="auto">
									<el-table-column prop="SettlementAmount" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="SAmount" label="已收款" width="auto">
									<el-table-column prop="SAmount" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="OwnAmount" label="未收款" width="auto">
									<el-table-column prop="OwnAmount" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="SMark" label="收款说明" width="auto">
									<el-table-column prop="SMark" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="SupportNum" label="应收装载费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="SupportNum" label="应收配送司机费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="SupportNum" label="代垫费用1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="打包费1" width="auto">
									<el-table-column prop="name" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="SupportNum" label="装修费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="SupportNum" label="分拣费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
							...
							<el-table-column prop="SupportNum" label="应收配送搬运费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="Driver" label="司机" width="auto">
								...
								<el-table-column prop="SupportNum" label="送货1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="SupportNum" label="应收装卸费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="SupportNum" label="应付配送司机费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="DriverIDNumber" label="司机身份证号" width="auto">
								...
								<el-table-column prop="SupportNum" label="出库费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="SupportNum" label="出库仓储费1" width="auto">
									<el-table-column prop="SupportNum" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="Property4" label="自定义4" width="auto">
						...
						<div id="table_ls">
							...
							<div class="table_right">
								<el-table :data="tableData4" @cell-dblclick="dbrow1" @header-click="headerc1"  height="510" border style="width: 100%">
									<el-table-column type='selection' prop="" label="选定框" width="50">
										<el-table-column type="selection" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="ParName" label="合作方" width="110">
										<el-table-column prop="ParName" label="" width="auto" class-name="mohucha">
									...
									<el-table-column prop="OutDate" label="单据日期" width="110">
										<el-table-column prop="OutDate" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="NeedDeliveryDate" label="配送日期" width="110">
										<el-table-column prop="NeedDeliveryDate" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="OutID" label="单据编号" width="220">
										<el-table-column prop="OutID" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="CusCode" label="客户编号" width="auto">
									...
									<el-table-column prop="StockName" label="仓库仓位" width="auto">
									...
									<el-table-column prop="DeliveryAddress" label="收货地址" width="auto">
										<el-table-column prop="DeliveryAddress" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="BodyProperty1" label="自定义1" width="auto">
										<el-table-column prop="BodyProperty1" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="BodyProperty2" label="自定义2" width="auto">
										<el-table-column prop="BodyProperty2" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="BoxCode" label="箱条码" width="auto">
										<el-table-column prop="BoxCode" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="BodyProperty3" label="自定义3" width="auto">
										<el-table-column prop="BodyProperty3" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="CusAreaName" label="客户区域" width="auto">
										<el-table-column prop="CusAreaName" label="" width="auto" class-name="mohucha">
									...
									<el-table-column prop="BodyProperty4" label="自定义4" width="auto">
										<el-table-column prop="BodyProperty4" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="Delivery" label="交货方式" width="auto">
										<el-table-column prop="Delivery" label="" width="auto" class-name="mohucha">
									...
									<el-table-column prop="CBPrice" label="参考成本价" width="auto">
										<el-table-column prop="CBPrice" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									...
									<el-table-column prop="InDate" label="入库日期" width="auto">
										<el-table-column prop="InDate" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
						...
						<div id='table_hz'>
							...
							<div class="table_right">
								<el-table :data="tableData5" @cell-dblclick="dbrow2" @header-click="headerc2"  height="510" border style="width: 100%">
									...
									<el-table-column prop="MLTotal" label="金额" width="auto">
										<el-table-column prop="MLTotal" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="BarCode" label="子条码" width="auto">
										<el-table-column prop="BarCode" label="" width="auto" class-name="mohucha">
										</el-table-column>
									</el-table-column>
									<el-table-column prop="BoxCode" label="箱条码" width="auto">
			...
			onSearch() {
				...
				if(that.activeName == 'djlb') {
					...
					$.ajax({
						...
						data: {
							datas: jsons,
							method: "CPHH.PC.OutModule.Out.BillReport",
							// test: 'test'
						},
						timeout: 3000, //超时时间
						success: function(data, textStatus, jqXHR) {
					...
					$.ajax({
						...
						data: {
							datas: jsons,
							method: "CPHH.PC.OutModule.Out.ProReport",
							// test: 'test'
						},
						timeout: 5000, //超时时间
						success: function(data, textStatus, jqXHR) {
					...
					$.ajax({
						...
						data: {
							datas: jsons,
							method: "CPHH.PC.OutModule.Out.ProSumReport"
						},
						timeout: 3000, //超时时间
						success: function(data, textStatus, jqXHR) {
							var obj = eval('(' + data + ')');
