<template>
	<div class='ckjhjhd'>
		...
		<el-tabs v-model='activeName' type="border-card">
			<el-tab-pane name='101' :disabled="step != 1" label="选择出库订单">
				<div class='xzckdd'>
					<el-form :inline="true" class="demo-form-inline form1">
						<el-row :gutter="10">
							...
							<el-col :span="2">
								<div class="grid-content ">
									<!-- 理货列表 -->
									<el-select v-model="tally" default-first-option no-data-text="无数据" filterable :filter-method="getCode" class='hzf  input_width'>
										<el-option v-for="item in tallyList" :key="item.Code" :label="item.label" :value="item.value">
										</el-option>
									</el-select>
									<!-- 理货结束 -->
								</div>
							...
							<el-col :span="2">
								<div class="grid-content fr">
									<el-button type="primary" size="small" @click.native='seach' class='cx' icon='search'>查询</el-button>
								</div>
							</el-col>
						</el-row>
					...
					<!--表格-->
					<div class='table'>
						<el-table :data="tableData3" height="520" border style="width: 100%" 
						...
						v-loading.body="loading" element-loading-text="玩命加载中">
							...
							<el-table-column prop="NeedDeliveryDate" label="交货日期" width="auto">
							...
							<el-table-column prop="Line" label="线路" width="auto">
								<el-table-column prop="Line" label="" width="auto" class-name="mohucha">
								</el-table-column>
							</el-table-column>
							<el-table-column prop="SendSerialNumber" label="配送序号" width="auto">
								<el-table-column prop="SendSerialNumber" label="" width="auto" class-name="mohucha">
								</el-table-column>
							</el-table-column>
							...
							<el-table-column prop="ZX" label="跨合作方入出库进度" width="auto">
								<el-table-column prop="ZX" label="" width="auto" class-name="mohucha">
								</el-table-column>
							</el-table-column>
							<el-table-column prop="StepParPlanMark" label="跨合作方入出库单据" width="auto">
								<el-table-column prop="StepParPlanMark" label="" width="auto" class-name="mohucha">
								</el-table-column>
							</el-table-column>
							...
							<el-table-column prop="ArrangeMark" label="理货进度" width="auto">
								<el-table-column prop="ArrangeMark" label="" width="auto" class-name="mohucha">
								</el-table-column>
							</el-table-column>
			...
			<div class="explain" style="color: black">
				<span style="float: left;">说明：</span><span style="width:50px; height: 27px; background: #cb7806; float: left; margin: 0 10px;"></span> 跨合作方入出库类单据
			</div>
			</el-tab-pane>
			<el-tab-pane name='102' :disabled="step != 2" label="选择分配规则">
				<el-row :gutter="10">
					<!--check-->
					<el-col :span="2">
						<div class="grid-content ">
					...
					<el-col :span="2">
						<div class="grid-content ">
							<span class=''>效期管控:</span>
						</div>
					</el-col>
					<el-col :span="3">
						<div class="grid-content ">
							<!-- 效期管控列表 -->
							<el-select v-model="xqgk" default-first-option no-data-text="无数据" class='hzf  input_width'>
								<el-option v-for="item in xqgkList" :key="item.value" :label="item.label" :value="item.value">
								</el-option>
							</el-select>
							<!-- 合效期管控列表结束 -->
						</div>
				...
				<el-row :gutter="10">
					<el-col :span="2">
						<div class="grid-content ">
							<el-checkbox v-model="checked1">打印整货标签:</el-checkbox>
						</div>
					</el-col>
					<el-col :span="4">
						<div class="grid-content ">
							<div class='pailiekuang'>
								<el-radio class="radio" v-model="radio" label="1">全部</el-radio>
								<el-radio class="radio" v-model="radio" label="2">制定份数
					...
					<el-col :span="2">
						<div class="grid-content ">
								<el-checkbox v-model="checked2">打印散货标签:</el-checkbox>
						</div>
					</el-col>
					<el-col :span="1">
						<div class="grid-content ">
			...
			<el-tab-pane name='103' :disabled="step != 3" label="预览分配结果">
				<div class='ylfp'>
					<div class='table'>
						<el-table :data="tableData" height="520" border style="width: 100%" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中" @selection-change="handleSelectionChange">
		...
		<div class='tongji'>
			<div class="left">
				<span style="float:left">参照预配单号： </span>
				<span style="float: left">123131
			 	 </span>
			</div>
			<div class="right">
				...
				this.ajax({
					...
					data:{
						datas:{
							...
							ArrangeMark: this.tally
						},
						method:'CPHH.PC.PDAModule.PickPlan.GetOutOrderList'
					},
