...
<!-- 调拨入库单列表 -->
	<div class="tbrkdlb">
			...
			<div class="but-box">
				<ul>
					<li><div class="boxtab"><div class="curbox xz" ><router-link to='dbrkdxz'><span>新增</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox xg" ><router-link to='dbrkdxg'><span>修改</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox ck" ><router-link to='dbrkdck'><span>查看</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox sc" ><span>作废</span></div></div><span class="gun"></span></li>
					...
					<li><div class="boxtab"><div class="curbox sh" ><span>审核</span></div></div>
						<div class="boxtab"><div class="curbox dc" ><span>导出</span></div></div><span class="gun"></span</li>
		...
		<el-table :data="tableData3" height="300" border style="width: 100%" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中"  >
			...
			<el-table-column prop="address" label="供应商" width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			...
			<el-table-column prop="address" label="打印次数" sortable width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
