<template>
	<div class='ckzy'>
      ...
      <el-row :gutter="10" type="flex">
		...
		<!-- 内部弹窗 -->
		<!--叉车工弹窗-->
		<el-dialog id='ccgtc' title="选择人员" :visible.sync="forkliftPopup">
			<div class='table'>
				<div class="but-box">
				<ul>
					<li>
			...
			<!--仓管员弹窗-->
		<el-dialog id='cgytc' title="选择人员" :visible.sync="warehouseKeeperPopup">  
			<div class='table'>
				<div class="but-box">
					<ul>
						<li>
		...
		<!--司机弹窗-->
		<el-dialog id='sjtc' title="司机档案列表" :visible.sync="chauffeurPopup">
		<!-- 这里是导航栏部分 -->
			<div class="but-box">
				<ul>
					<li>
		...
		<!--车牌弹窗-->
		<el-dialog id='cltc' title="车辆档案列表" :visible.sync="licencePlatePopup">
			<!-- 这里是导航栏部分 -->
			<div class="but-box">
				<ul>
					<li>
...
<script>
	export default {
      ...
      that.storageData = JSON.parse(that.orderInfo);
			console.log(that.storageData);
			that.getDataInfo(that.storageData);
		},
		methods: {
			getDataInfo (data) {
        this.peisong = data.DCName;
        var that = this;
				// 叉车工
				var ccparams = {
					JobType: '叉车工',
