...
<!-- 损溢单序时簿 -->
	<div class="sydxsb">
			...
			<div class="but-box">
				<ul>
					<li><div class="boxtab"><div class="curbox xz" ><router-link to='syd'><span>新增</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox xg" ><router-link to='sydxg'><span>修改</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox ck" ><router-link to='sydck'><span>查看</span></router-link></div></div></li>
					...
					<li><div class="boxtab"><div class="curbox sh" @click='djt_Click=true'><span>初核</span></div></div></li>
					<li><div class="boxtab"><div class="curbox sh" @click='djt_Click=true'><span>审核</span></div></div></li>
					<li><div class="boxtab"><div class="curbox sh" @click='djt_Click=true'><span>批量审核</span></div></div><span class="gun"></span></li>
		...
		<el-table :data="tableData3" height="300" border style="width: 100%" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中"  >
			...
			<el-table-column prop="name" label="初审" width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			...
			<el-table-column prop="address" label="损溢类型" width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			...
			<el-table-column prop="address" label="损溢金额" sortable width="160">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			...
			<el-table-column prop="address" label="打印次数" width="100">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			<el-table-column prop="address" label="制单人" width="100">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			...
			<el-table-column prop="address" label="审核日期" width="120">
      		...
      		<el-table-column prop="name" label="初审人" width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			<el-table-column prop="name" label="初审日期" width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			<el-table-column prop="address" sortable label="体积" width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
			...
			<el-table-column prop="address" label="制单日期" width="120">
			  	<el-table-column  prop="name" label="" width="auto" class-name="mohucha">
				</el-table-column>
      		</el-table-column>
