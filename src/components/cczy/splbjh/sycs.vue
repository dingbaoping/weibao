...
<!-- 损溢初审 -->
	<div class="tbcksp">
			...
			<div class="but-box">
				<ul>
					<li><div class="boxtab"><div class="curbox sh" @click='auditOrder'><span>初审</span></div></div><span class="gun"></span></li>
		...
		<!--表格开始-->
		<div class="datatable">
			<el-table :data="tableData4" border  @cell-dblclick="dbrow" @header-click="headerc" style="width: 100%" height="550">
