		...
		<div class="chaxun">
			...
			<el-row :gutter="10" type="flex">
				...
				<el-col :xs="5" :sm="5" :md="5" :lg="5">
					<div class="grid-content  ">
						<!-- 园区列表 -->
						<el-select v-model="yuanqu" placeholder="" no-data-text="无数据" class=" blueborder input_width" disabled>
			...
			<el-row :gutter="10" type="flex">
				...
				<el-col :xs="5" :sm="5" :md="5" :lg="5">
					<div class="grid-content  ">
						<!-- 园区列表 -->
						<el-select disabled v-model="yuanqu" placeholder="" no-data-text="无数据" class=" blueborder input_width" disabled>
							<el-option v-for="item in yqlist" :key="item.ParkID" :label="item.ParkName" :value="item.ParkID">
								<span style="float: left">{{ item.ParkName }}</span>
							</el-option>
						</el-select>
					...
					<div id='table_dj'>
						<el-table :data="ddlbs" height="250" border style="width: 100%" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中">
							...
							<el-table-column prop="name" label="商品名称" width="160">
								<el-table-column prop="TransportCmpName" label="" width="160" class-name="mohucha">
								</el-table-column>
							</el-table-column>
							...
							<el-table-column prop="address" label="" width="55">
								<el-table-column prop="TransportCmpName" label="" width="55" class-name="mohucha">
								</el-table-column>
							</el-table-column>
							<!--仓位的按钮部分-->
