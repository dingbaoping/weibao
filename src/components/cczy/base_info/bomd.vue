	...
	<div class="bomd">
		...
		<div class="but-box">
			<ul>
				<li>
					<div class="boxtab">
						<router-link to="bomdxz" class="watch">
							<div class="curbox ck">新增</div>
				...
				<li>
					<div class="boxtab">
						<div class="curbox sc" ><span>停用</span></div>
					</div>
				</li>
				<li>
					<div class="boxtab">
		...
		<div class="chaxunkuang">
			<div class="formcx ccgl-r">
				...
				<el-form class="demo-ruleForm">
					<el-form-item required>
						<el-col class="lines" :span="2" :offset="2">
							<div class="grid-content">
								<p>配送中心：</p>
							</div>
						</el-col>
		...
		<div class="table">
			<el-table :data="tableData3" height="600" border style="width: 100%" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中">
				...
				<el-table-column prop="name" label="BOM单编号" width="120">
					<el-table-column prop="name" label="" width="auto" class-name="mohucha">
					</el-table-column>
				</el-table-column>
				<el-table-column prop="address" sortable label="商品编号" width="120">
					<el-table-column prop="name" label="" width="auto" class-name="mohucha">
					</el-table-column>
				</el-table-column>
				...
				<el-table-column prop="address" label="备注" sortable width="160">
					<el-table-column prop="name" label="" width="auto" class-name="mohucha">
					</el-table-column>
				</el-table-column>
