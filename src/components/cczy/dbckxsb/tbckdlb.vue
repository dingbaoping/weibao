		...
		<!--调拨出库单列表-->
			...
			<div class="but-box">
				<ul>
					...
					<li><div class="boxtab"><div class="curbox sh" ><span>发起审核</span></div></div></li>
					<li><div class="boxtab"><div class="curbox sh" ><span>出库审核</span></div></div><span class="gun"></span</li>
