		...
		<div class="chaxun">
			...
			<el-row :gutter="10" type="flex">
					...
					<el-col :xs="5" :sm="5" :md="5" :lg="5">
						<div class="grid-content  ">
							<!-- 配送中心列表 -->
							<el-select v-model="peisong" @change="pschange" filterable placeholder="" class=" blueborder input_width" disabled>
					...
					<el-col :xs="5" :sm="5" :md="5" :lg="5">
						<div class="grid-content  ">
							<!-- 园区列表 -->
							<el-select v-model="yuanqu" placeholder="" no-data-text=""   class=" blueborder input_width" disabled>
			...
			<el-row :gutter="10" type="flex">
					...
					<el-col :xs="5" :sm="5" :md="5" :lg="5">
						<div class="grid-content  ">
							<el-input disabled class=" input_width " size="small" placeholder="" v-model="djh" disabled>
							</el-input>
						</div>
					</el-col>
					<el-col :xs="8" :sm="8" :md="8" :lg="8">
					...
					<el-col :xs="5" :sm="5" :md="5" :lg="5">
						<div class="grid-content  ">
							<!-- 园区列表 -->
							<el-select disabled v-model="yuanqu" placeholder="" no-data-text=""   class=" blueborder input_width" disabled>
								<el-option  v-for="item in yqlist" :key="item.ParkID" :label="item.ParkName" :value="item.ParkID">
									<span style="float: left">{{ item.ParkName }}</span> 
								</el-option>
							</el-select>
			...
			<el-form class="demo-ruleForm el-row">
				...
				<el-col :xs="5" :sm="5" :md="5" :lg="5">
					<div class="grid-content  one">
						<!--下拉式合作方-->
						<el-select v-model="hzf" default-first-option no-data-text="无数据" filterable :filter-method="getCode" class='hzf  input_width' disabled>
				...
				<el-col :xs="5" :sm="5" :md="5" :lg="5">
					<div class="grid-content three">
						<!--调拨类型开始-->
						<el-select v-model="dbnx" placeholder="" class=" blueborder input_width" disabled>
