				...
				<div class="right">
					...
					<div class='table-header'>
						<el-table :data="splbs" ref="selectData" @row-dblclick="dbHandle" @selection-change="handleSelectionChange"height="340" border style="width: 100%">
							...
							<el-table-column prop="ConvRate" label="换算率" width="100" class-name="mohucha">
							</el-table-column>
							<el-table-column prop="Manufacturer" label="生产厂商" width="100" class-name="mohucha">
							</el-table-column>
							<el-table-column prop="Memarks" label="备注" width="100" class-name="mohucha">
							</el-table-column>
						</el-table>
						<ul class='r1'>
							<li>
