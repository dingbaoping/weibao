...
<!-- 组装拆卸序时簿 -->
	<div class="zzcxxsb">
			...
			<div class="but-box">
				<ul>
					<li><div class="boxtab"><div class="curbox xz" ><router-link to='zzcxxz'><span>新增</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox xg" ><router-link to='zzcxxg'><span>修改</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox ck" ><router-link to='zzcxck'><span>查看</span></router-link></div></div></li>
