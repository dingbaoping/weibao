			...
			<el-tabs type="border-card">
				<el-tab-pane label="作业明细">
					<el-table :data="tableData3" height="300" border style="width: 100%" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中">
						...
						<el-table-column prop="address" sortable label="商品名称" width="120">
							<el-table-column prop="name" label="" width="120" class-name="mohucha">
							</el-table-column>
						</el-table-column>
						...
						<el-table-column prop="address" label="批次" sortable width="160">
							<el-table-column prop="name" label="" width="120" class-name="mohucha">
							</el-table-column>
						</el-table-column>
						<el-table-column prop="address" label="生产日期" sortable width="120">
							<el-table-column prop="name" label="" width="120" class-name="mohucha">
							</el-table-column>
						</el-table-column>
						<el-table-column prop="address" label="有效期至" width="100">
							<el-table-column prop="name" label="" width="120" class-name="mohucha">
							</el-table-column>
						</el-table-column>
						<el-table-column prop="address" label="托盘号" width="100">
							<el-table-column prop="name" label="" width="120" class-name="mohucha">
							</el-table-column>
						</el-table-column>
						<el-table-column prop="address" label="调出数量" width="120">
							<el-table-column prop="name" label="" width="120" class-name="mohucha">
							</el-table-column>
						</el-table-column>
						<el-table-column prop="address" label="调出辅助数量" width="150">
						...
						<el-table-column prop="address" label="调入数量" sortable width="120">
							<el-table-column prop="name" label="" width="120" class-name="mohucha">
							</el-table-column>
						</el-table-column>
						<el-table-column prop="address" label="调入辅助数量" sortable width="150">
							<el-table-column prop="name" label="" width="150" class-name="mohucha">
							</el-table-column>
						</el-table-column>
