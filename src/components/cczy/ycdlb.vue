...
<!-- 移仓单列表 -->
	<div class="ycdlb">
			...
			<div class="but-box">
				<ul>
					<li><div class="boxtab"><div class="curbox xz" ><router-link to='ycd'><span>新增</span></router-link></div></div></li>
					<li><div class="boxtab"><div class="curbox xz" ><router-link to='ycdxg'><span>修改</span></router-link></div></div></li> 
					 <!--对应移仓单修改页面-->
					<li><div class="boxtab"><div class="curbox ck" ><router-link to='ycdck'><span>查看</span></router-link></div></div></li>
					...
					<li><div class="boxtab"><div class="curbox fpry" ><span>审核</span></div></div><span class="gun"></span></li>
