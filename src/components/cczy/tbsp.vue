	...
	<div class="tbsp">
			...
			<div class="but-box">
				<ul>
					...
					<li><div class="boxtab"><div class="curbox sh" @click='djt_Click=true'><span>发起审核</span></div></div><span class="gun"></span></li>
		...
		<div class="datatable">
			<el-table :data="ddlbs" height="250" border style="width: 100%"  @cell-dblclick="dbrow" @header-click="headerc"  v-loading.body="loading"  element-loading-text="玩命加载中">
				...
				<el-table-column prop="FXBH" label="审核标志" width="150">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="FXMC" label="单据编号" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="JSDX" label="日期" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="JSDXMC" label="调拨类型" width="120" >
					<el-table-column prop="JSDXMC" label="" width="120" class-name="mohucha">
					</el-table-column>
				</el-table-column>
				<el-table-column prop="FXLX" label="合作方" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column> 
				<el-table-column prop="JFDJ" label="调出金额" width="120">
				<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="DJBH" label="调入金额" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column sortable prop="DJRQ" label="调拨差额" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				...
				<el-table-column prop="zip" label="提交状态" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="基本状态" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="辅助数量" width="120">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				...
				<el-table-column prop="zip" label="调出配送中心" width="150">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="调入配送中心" width="150">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				...
				<el-table-column prop="zip" label="装卸开始时间" width="150">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="装卸结束时间" width="150">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				...
				<el-table-column prop="zip" label="司机身份证号" width="150">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
				...
				<el-table-column prop="zip" label="调拨订单号" width="150">
					<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
				</el-table-column>
			</el-table>
