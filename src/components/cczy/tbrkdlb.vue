	...
	<div class="tbrkdlb">
			...
			<div class="but-box">
				<ul>
					...
					<li><div class="boxtab"><div class="curbox sh" @click='djt_Click=true'><span>审核</span></div></div>
						<div class="boxtab"><div class="curbox dc" @click='djt_Click=true'><span>导出</span></div></div><span class="gun"></span</li>
