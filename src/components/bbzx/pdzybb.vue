						...
						<div id='table_dj'>
							...
							<div class='table'>
								<el-table :data="tableData6" border height="200" :summary-method="getSummaries" show-summary style="width: 100%; margin-top: 20px">
									...
									<el-table-column prop="name" label="操作员姓名">
									</el-table-column>
									<el-table-column prop="amount1" label="散货">
									</el-table-column>
									<el-table-column prop="amount2" label="整箱">
									</el-table-column>
									<el-table-column prop="amount3" label="体积">
									</el-table-column>
									<el-table-column prop="amount4" label="重量">
									</el-table-column>
								</el-table>
					...
					<el-tab-pane label="明细报表">
						<div id='table_dj'>
							<el-table :data="ddlbs" height="250" border style="width: 100%"  @cell-dblclick="dbrow" @header-click="headerc"  v-loading.body="loading"  element-loading-text="玩命加载中">
								...
								<el-table-column prop="name" label="盘点单号" width="110">
								<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
								</el-table-column>
