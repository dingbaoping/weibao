		...
		<div class="searchnav">
			...
			<el-form :inline="true" :model="formInline" class="demo-form-inline form1">
				<el-row :gutter="10" class="row-1">
					...
					<el-col :span="3">
						<div class="grid-content ">
							<el-select v-model="rq1" placeholder="日期" class='fl rq2'>
			...
			<div class='button_row'>
				...
				<el-tabs type="border-card">
					<el-tab-pane label="流水台账">
						<div id='table_dj'>
							<el-table :data="tableData3" height="250" @cell-dblclick="dbrow" @header-click="headerc" border style="width: 100%" v-loading.body="loading"  element-loading-text="玩命加载中">
								...
								<el-table-column prop="address" label="库位" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="基本账存数量" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="基本仓存数" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="辅助账存数量" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="辅助仓存数" width="150">
								...
								<el-table-column prop="address" label="账存金额" width="180">
					...
					<el-tab-pane label="汇总台账">
						<div id='table_dj'>
							<el-table :data="tableData3" height="250" @cell-dblclick="dbrow" @header-click="headerc" border style="width: 100%" v-loading.body="loading"  element-loading-text="玩命加载中">
								...
								<el-table-column prop="address" label="基本单位账存" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="基本单位仓存" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="辅助单位" width="110">
								...
								<el-table-column prop="address" label="辅助单位账存" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="辅助单位仓存" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="生产日期" width="110">
								...
								<el-table-column prop="address" label="仓存金额" width="180">
								<el-table-column prop="address" label="" width="180" class-name="mohucha">
								</el-table-column>							
							</el-table-column>							
							</el-table>
