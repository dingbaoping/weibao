					...
					<el-tab-pane label="按合作方">
						<div id='table_dj'>
							<el-table :data="ddlbs" height="250" border style="width: 100%"  @cell-dblclick="dbrow" @header-click="headerc"  v-loading.body="loading"  element-loading-text="玩命加载中">
								...
								<el-table-column prop="address" label="确认配送-配送费" width="200">
									<el-table-column  prop="CheckMark" label="" width="200" class-name="mohucha">
				</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="完成签收-配送费" width="200">
									<el-table-column  prop="CheckMark" label="" width="200" class-name="mohucha">
				</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="已结算" width="110">
									<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="未结算" width="110">
									<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="应收退货费" width="150">
									<el-table-column  prop="CheckMark" label="" width="150" class-name="mohucha">
				</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="应收随车带回退货费" width="200">
									<el-table-column  prop="CheckMark" label="" width="200" class-name="mohucha">
				</el-table-column>
								</el-table-column>
							</el-table>
