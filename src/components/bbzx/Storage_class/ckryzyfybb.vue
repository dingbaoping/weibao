			...
			<div class='button_row'>
				...
				<el-tabs type="border-card">
					<el-tab-pane label="单据列表">
						<div id='table_dj'>
							<el-table :data="tableData4" height="250" @cell-dblclick="dbrow" @header-click="headerc" border style="width: 100%">
								...
								<el-table-column prop="name" label="业务模块" width="110">
								<el-table-column prop="name" label="" width="110 " class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="费用名称" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="费用比例" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="费用金额" width="110">
								<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
							</el-table-column>
							</el-table>
