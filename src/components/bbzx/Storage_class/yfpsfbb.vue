					...
					<el-form-item required>
						...
						<el-col :span="2">
							<el-form-item prop="peisong">
								<el-select v-model="rul" placeholder="请选择">
						...
						<el-col :span="1">	
							<el-form-item prop="peisong">
								<el-input class="inline-input" placeholder="" v-model="ruleForm.region">
								</el-input>
							</el-form-item>
						</el-col>
		...
		<div class='table'>
			<div class='button_row'>
				...
				<el-tabs type="border-card">
					<el-tab-pane label="按承运公司">
						<div id='table_dj' class="el-table">
							<el-table :data="ddlbs" height="250" border style="width: 100%"  @cell-dblclick="dbrow" @header-click="headerc"  v-loading.body="loading"  element-loading-text="玩命加载中">
								...
								<el-table-column prop="address" label="配送确认-配送费" width="200">
									<el-table-column  prop="TransportCmpName" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="签收完成-配送费" width="200">
									<el-table-column  prop="TransportCmpName" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="财务审核-配送费" width="200">
									<el-table-column  prop="TransportCmpName" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="已支付" width="110">
									<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="未支付" width="110">
									<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="应付退货费" width="150">
									<el-table-column  prop="TransportCmpName" label="" width="150" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="应付随车带回退货费" width="200">
									<el-table-column  prop="TransportCmpName" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="搬运费" width="110">
									<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>							
								<el-table-column prop="address" label="上楼费" width="110">
								<el-table-column  prop="TransportCmpName" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
							</el-table>
...
<style>
	...
	.yfpsfbb .el-form-item__content {
		margin-top: 6px;
		margin-left: 10px;
	}
	
	/*.yfpsfbb .el-table th>.cell {
		line-height: normal;
	}*/
	
	.yfpsfbb .el-table tr:nth-child(2) th {
		background: none;
	}
	.yfpsfbb .el-input__icon{
		top: 5px;
	}
	.yfpsfbb .el-button{
		padding: 6px 15px;
	}
	.yfpsfbb .el-tabs__content{
