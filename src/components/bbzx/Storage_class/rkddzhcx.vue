<template>
	<!-- 出库订单综合查询 -->
	<div class='rkddzhcx' id='rkddzhcx'>
		<!--出库管理综合报表-->
		...
		<div class="but-box">
			<ul>
				<li>
					<div class="boxtab">
						<div class="curbox dc" @click='djt_Click=true'>
							<span>导出</span>
						</div>
					</div>
					<span class="gun"></span>
				...
				<el-row :gutter="10" class="row-1">
					...
					<el-col :span="3">
							<el-form-item prop="date1">
								<el-date-picker type="date" class='input_width' placeholder="选择日期" v-model="ruleForm.date1"  :picker-options="pickerOptions1" style="width: 100%;"></el-date-picker>
							</el-form-item>
						</el-col>
						...
						<el-col :span="3">
							<el-form-item prop="date2">
								<el-date-picker type="date" class='input_width' placeholder="选择日期" v-model="ruleForm.date2"  :picker-options="pickerOptions2" style="width: 100%;"></el-date-picker>
							</el-form-item>
						</el-col>
					<el-col :span="2">
						<div class="grid-content ">
			...
			<div class='button_row'>
				...
				<el-tabs type="border-card">
					<el-tab-pane label="单据列表">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="560" border style="width: 100%">
								...
								<el-table-column prop="name" label="运输方式" width="110">
								...
								<el-table-column prop="address" label="入库类型" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="关闭理由" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="预计到达时间" width="150" >
								<el-table-column prop="address" label="" width="150" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="关闭人" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="合作方" width="110">
									<el-table-column prop="address" label="合作方" width="110" class-name="mohucha">
								</el-table-column>
									
									
								</el-table-column>

								<el-table-column prop="address" label="入库状态" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="关闭时间" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
					...
					<el-tab-pane label="流水台账">
						<div id="table_ls">
							<div class='table_left'>
								<el-tree :data="data_tree1" :props="defaultProps"  ></el-tree>
							</div>
							<div class="table_right">
								<el-table :data="tableData4" height="530" @cell-dblclick="dbrow" @header-click="headerc" border style="width: 100%">
									<el-table-column type='selection' prop="" label="选定框" width="50">
									</el-table-column>
									...
									<el-table-column prop="address" label="源单号" width="110" class-name="mohucha">
										<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
									</el-table-column>
									<el-table-column prop="address" label="业务员" width="110">
									...
									<el-table-column prop="address" label="体积" width="110" >
										<el-table-column prop="address" label="体积" width="110" class-name="mohucha">
									</el-table-column>
									</el-table-column>
									<el-table-column prop="address" label="重量" width="110" class-name="mohucha">
										<el-table-column prop="address" label="重量" width="110" >
									</el-table-column>
									</el-table-column>
								</el-table>
					...
					<el-tab-pane label="汇总台账">
						<div id='table_hz'>
							<div class='table_left'>
								<el-tree :data="data_tree2" :props="defaultProps" ></el-tree>
							</div>
							<div class="table_right">
								<el-table :data="tableData5" @cell-dblclick="dbrow" @header-click="headerc" height="530" border style="width: 100%">
									<el-table-column type='selection' prop="" label="选定框" width="50">
									</el-table-column>
									<el-table-column prop="name" label="合作方" width="110">
										<el-table-column prop="name" label="" width="110" class-name="mohucha">
