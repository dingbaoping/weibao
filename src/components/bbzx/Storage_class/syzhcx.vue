					...
					<el-tab-pane label="单据列表">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="250" border style="width: 100%">
								...
								<el-table-column prop="name" label="初审" width="110">
								...
								<el-table-column prop="address" label="损溢类型" width="110">
								...
								<el-table-column prop="address" label="损溢金额" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="初审日期" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="初审人" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
							</el-table>
