					...
					<el-tab-pane label="汇总表">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="600" border style="width: 100%">
								...
								<el-table-column prop="name" label="需配送日期" width="150">
								...
								<el-table-column prop="address" label="车次" width="110">
								<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
					...
					<el-tab-pane label="明细报表">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="600" border style="width: 100%">
								...
								<el-table-column prop="name" label="预配单号" width="110">
								<el-table-column prop="name" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="name" label="审核时间" width="110">
								<el-table-column prop="name" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="车牌号" width="110">
								...
								<el-table-column prop="address" label="出库订单号" width="150">
								...
								<el-table-column prop="address" label="大仓名称" width="110">
								<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="预配备注" width="110">
								<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
					...
					<el-tab-pane label="商品明细">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="600" border style="width: 100%">
								...
								<el-table-column prop="address" label="承运司机方" width="110">
								<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="出库订单号" width="110">
								<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="客户编号" width="110">
								...
								<el-table-column prop="address" label="预配基本数量" width="150">
								<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="预配辅助数量" width="150">
								<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="实际基本数量" width="150">
								<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="实际辅助数量" width="150">
								<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="数据来源" width="110">
								<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="库存基本数量" width="150">
								<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
