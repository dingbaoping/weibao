				...
				<el-row :gutter="10" class="row-1">
					...
					<el-col :span="2">
						<div class="grid-content ">
							...
							<!-- 园区列表 -->
							<el-select v-model="yuanqu" placeholder="全部" no-data-text="无数据" class=" blueborder input_width">
					...
					<el-tab-pane label="汇总表">
						<div id='table_dj'>
							<el-table :data="tableData3"  @cell-dblclick="dbrow" @header-click="headerc" height="600" border style="width: 100%">
								...
								<el-table-column prop="address" label="原应付配送费" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>

								</el-table-column>
								<el-table-column prop="address" label="实际应付配送费" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
					...
					<el-tab-pane label="明细报表">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="600" border style="width: 100%">
								...
								<el-table-column prop="name" label="配送序号" width="110">
									<el-table-column prop="name" label="" width="110" class-name="mohucha">
									</el-table-column>
								...
								<el-table-column prop="name" label="发车时间" width="110">
									<el-table-column prop="name" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="车牌号" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="承运公司" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="司机" width="110">
								...
								<el-table-column prop="address" label="出库单号" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="客户区域" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>

								<el-table-column prop="address" label="路线" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>

								</el-table-column>
								<el-table-column prop="address" label="单据金额" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="单据类型" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="到达签收人" width="150">
									<el-table-column prop="address" label="" width="150" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="到达签收日期" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="到达签收操作人" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="到达签收操作日期" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="回单签收人" width="150">
									<el-table-column prop="address" label="" width="150" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="回单签收日期" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="回单签收操作人" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="回单签收操作日期" width="220">
									<el-table-column prop="address" label="" width="220" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="到达签收结果" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>

								<el-table-column prop="address" label="回单签收结果" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="到达签收备注" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="自定义1：" width="110">
									<el-table-column prop="address" label="：" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="自定义2：" width="110">
									<el-table-column prop="address" label="：" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="签收基本数量" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="签收辅助数量" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="验收单号" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="配送员2" width="110">
								...
								<el-table-column prop="address" label="返厂接收人" width="150">
									<el-table-column prop="address" label="" width="150" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="返厂日期" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="返厂备注" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="返厂操作人" width="150">
									<el-table-column prop="address" label="" width="150" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="返厂操作时间" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="回单状态" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="改派状态" width="110">
									<el-table-column prop="address" label="" width="110">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="改派操作人" width="150">
									<el-table-column prop="address" label="" width="150" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="改派操作时间" width="200">
									<el-table-column prop="address" label="" width="200" class-name="mohucha">
									</el-table-column>
								</el-table-column>

								<el-table-column prop="address" label="改派原因" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>

								</el-table-column>
								<el-table-column prop="address" label="改派备注" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="快递单号" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
									</el-table-column>
								</el-table-column>
							</el-table>
					...
					<el-tab-pane label="商品明细">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="600" border style="width: 100%">
								...
								<el-table-column prop="name" label="配送单号" width="auto">
									<el-table-column prop="name" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="配送日期" width="auto">
									<el-table-column prop="name" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="车牌号" width="auto">
									<el-table-column prop="name" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="司机" width="auto">
									<el-table-column prop="name" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="业务单号" width="auto">
								...
								<el-table-column prop="address" label="商品编号" width="auto">
									<el-table-column prop="address" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="承运方" width="auto">
									<el-table-column prop="address" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="费用单价" width="auto">
									<el-table-column prop="address" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="单据来源" width="auto">
									<el-table-column prop="address" label="" width="auto" class-name="mohucha">
									</el-table-column>
								</el-table-column>
							</el-table>
					...
					<el-tab-pane label="未配商品明细">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="600" border style="width: 100%">
								...
								<el-table-column prop="name" label="合作方" width="auto">
									<el-table-column prop="name" label="" width="auto"  class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="商品编号" width="auto">
									<el-table-column prop="name" label="" width="auto"  class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="name" label="业务单号" width="auto">
									<el-table-column prop="name" label="" width="auto"  class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="基本数量" width="auto">
