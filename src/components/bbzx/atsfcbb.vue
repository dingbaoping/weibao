					...
					<el-tab-pane label="报表">
						<div id='table_dj'>
							<el-table :data="ddlbs" height="250" border style="width: 100%"  @cell-dblclick="dbrow" @header-click="headerc"  v-loading.body="loading"  element-loading-text="玩命加载中">
								...
								<el-table-column prop="name" label="初期（基本数量）" width="180">
									<el-table-column  prop="TransportCmpName" label="" width="180" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="入库（基本数量）" width="180">
									<el-table-column  prop="TransportCmpName" label="" width="180" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="出库（基本数量）" width="180">
									<el-table-column  prop="TransportCmpName" label="" width="180" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="结存（基本数量）" width="180">
									<el-table-column  prop="TransportCmpName" label="" width="180" class-name="mohucha">
									</el-table-column>
								</el-table-column>
							</el-table>
