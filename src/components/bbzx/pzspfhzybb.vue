<template>
<!-- 播种作业报表 -->
	<div class='pzspfhzybb' id='pzspfhzybb'>
			<!-- 这里是导航栏部分结束 -->
			<div class="but-box">
				<ul>
			...
			<div class='button_row'>
				<el-tabs type="border-card">				
					...
					<el-tab-pane label="明细报表">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" v-loading.body="loading" element-loading-text="玩命加载中"  height="210" border style="width: 100%">
								<el-table-column type='selection' prop="" label="选定框" width="50">
									<el-table-column  prop="name" label="0" width="50" class-name="mohucha">
									</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="name" label="业务单号" width="110">
								<el-table-column  prop="name" label="" width="110" class-name="mohucha">
				                </el-table-column>
								</el-table-column>
