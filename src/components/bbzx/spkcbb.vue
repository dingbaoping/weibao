<template>
	...
	<div class="spkcbb">
				...
				<el-form class="demo-ruleForm">
					...
					<el-form-item required>
						...
						<el-col :span="5" :offset="1">
							<el-form-item prop="cxlx">
								<el-select v-model="ruleForm.cxlx" placeholder="查询类型">
									<el-option v-for="item in cxlxlist" :key="item.value" :label="item.label" :value="item.value">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
						...
						<el-col :span="3">
							<el-form-item prop="">
								<el-select v-model="tjfs" placeholder="统计方式">
									<el-option v-for="item in tjfslist" :key="item.value" :label="item.label" :value="item.value">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
						...
						<el-col :span="3">
							<div class="grid-content djbj">
								<el-input placeholder="选择商品" icon="search" v-model="input2" :on-icon-click="xzsp_Click=true">
								</el-input>
							</div>
						</el-col>
		...
		<div class="datatable">
			<div>
				<div class='title'> <h1>商品库存周转率</h1>  </div>
				<div><ul><li>开始日期<dl><dt>1899-12-30</dt></dl></li>
				<li>结束日期<dl><dt>0000-00-00</dt></dl></li></ul></div>
				<div><p>周转率计数结果不计算当天的出库量，如果结束日期为当天则查询结果为截止前一天数据</p></div>
			...
			<el-table :data="tableData4" border v-loading.body="loading" @cell-dblclick="dbrow" @header-click="headerc" element-loading-text="玩命加载中" style="width: 100%" height="550">
				<el-table-column label="#" width="60">
					 <el-table-column type="selection"  prop="" label="" width="60">
			  </el-table-column>
				</el-table-column>
				<el-table-column prop="FXBH" label="货主名称" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="FXMC" label="商品编码" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="JSDX" label="商品名称" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="JSDXMC" label="期初金额" width="110" sortable>
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="FXLX" label="期末金额" width="110" sortable>
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="JFDJ" label="出库金额" width="110" sortable>
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="DJBH" label="周转率" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
	...
	export default {
		...
		data() {
			...
			return {
				...
				cxlx:"",
				tjfs:'',
				cxlxlist:[{label:'明细', value:'21'},{label:'汇总',value:'22'}],
				tjfslist:[{label:'成本金额',value:'',},{label:'基本数量',value:'',},{label:'辅助数量',value:'',},],
				peisong:'',
				cities:'',
				hzf:'',
				options:'',
...
<style>
	.spkcbb .el-form-item__content {
		line-height: 50px;
	}
	
	.spkcbb .el-input__icon {
		top: 12px;
	}
	
	.spkcbb .grid-content p {
		text-align: center;
	}
	
	.spkcbb .buttondiv button {
		padding: 6px 15px;
		margin-top: 10px;
	}
	...
	.spkcbb .el-form-item__content div {
		height: 40px;
	}
	
	.spkcbb .el-select .el-input__icon {
		top: 24px;
	}
