  ...
  <div class="yszkhzb">
    ...
    <div class="distributionCenter">
      ...
      <!-- 配送中心列表 -->
							...
							<!-- 配送中心列表结束 -->
			<el-input v-model="input" placeholder="" class='input_width'></el-input>
      <el-button type="primary" class="btn" v-model="button">...</el-button>
    ...
    <div class="providerInfo">
     <p>供应商的内容,共计1条记录</p>
      <el-table :data="options[value].tableData[date].providerInfo" border style="width: 100%" :default-sort="{prop: 'date', order: 'descending'}">
        ...
        <el-table-column prop="name" label="名称" sortable width="213">
        </el-table-column>
        <el-table-column prop="due" label="期初应收" sortable width="130">
        </el-table-column>
        <el-table-column prop="rental" label="总额" sortable width="130">
        </el-table-column>
        <el-table-column prop="paid" label="已付" sortable width="130">
        </el-table-column>
        <el-table-column prop="advance" label="预付款" sortable width="130">
        </el-table-column>
        <el-table-column prop="advanceBalance" label="预付款余额" sortable width="130">
        </el-table-column>
        <el-table-column prop="balance" label="余额" sortable width="130">
        </el-table-column>		
      </el-table>
    </div>
  </div>
...
.yszkhzb .el-input__inner {
	margin: 5px 0;
}
.yszkhzb .distributionCenter .el-button {
	position: absolute;
	right: 3px;
	top: 45px;
	line-height: 1px;
...
.yszkhzb .el-table__empty-block {
  min-height: 575px;
}
.yszkhzb .distributionCenter .el-table__body-wrapper {
  min-height: 542px;;
}
.yszkhzb .providerInfo .el-table__body-wrapper {
  min-height: 592px;;
}
.yszkhzb button{
	padding: 6px 15px;
