	...
	<div class="hzfyszh">
		...
		<div class="datatable">
			...
			<el-table :data="ddlbs" height="250" border style="width: 100%"  @cell-dblclick="dbrow" @header-click="headerc"  v-loading.body="loading"  element-loading-text="玩命加载中">
				...
				<el-table-column prop="zip" label="客户区域ID" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="客户区域名称" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="计费方式" width="110">
				...
				<el-table-column prop="zip" label="阶梯实际方式" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="阶梯计费价格" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="zip" label="说明" width="110">
...
<style>
	.hzfyszh .el-form-item__content{
		line-height: 60px;
	}
	.hzfyszh .el-input__icon{
		top: 17px;
	}
	.hzfyszh .grid-content p{
		text-align: center;
	}
	.hzfyszh .buttondiv button{
		padding:6px 15px;
		/*margin-top: 13px;*/
	}
	.hzfyszh .grid-content{
		margin: 0!important;
	}
	.hzfyszh .buttondiv{
		margin-top: 0;
