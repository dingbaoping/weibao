				...
				<el-row :gutter="10" class="row-1">
					...
					<el-col :span="2">
						<div class="grid-content ">
							<el-select v-model="ckrq" placeholder="出库日期" class="shbz">
								<el-option v-for="item in ckrqlist" :label="item.label" :value="item.value">
								</el-option>
							</el-select>
						</div>
					</el-col>
					...
					<el-col :span="2">					
						<div class="grid-content ">
							<el-select v-model="shbz" placeholder="全部" class="
								 shbz">
					...
					<el-col :span="2" offset="">
						<div class="grid-content pszx">
							<p class='left-1'>配送中心:</p>
						</div>
					</el-col>
					<el-col :span="3" class="pszx">
						<div class="grid-content ">
							<!-- 配送中心列表 -->
			...
			<div class='button_row'>
				...
				<el-tabs type="border-card">
					<el-tab-pane label="单据列表">
						<div id='table_dj'>
							<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="560" border style="width: 100%">
								...
								<el-table-column prop="name" label="单据日期" width="110">
									<el-table-column prop="name" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="业务员" width="110">
									<el-table-column prop="address" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column type='selection' prop="" label="交货方式" width="110">
									<el-table-column type='selection' prop="" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="实际配送日期" width="150">
								...
								<el-table-column prop="name" label="审核人" width="110">
									<el-table-column prop="name" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="审核日期" width="110">
									<el-table-column prop="name" label="" width="110" class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="需配送日期" width="150">
									<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="签收日期" width="110">
									<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="配送单号" width="110">
									<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="单据级别" width="110">
									<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column type='selection' prop="" label="配送距离" width="110">
									<el-table-column type='selection' prop="" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="name" label="运费	" width="110">
									<el-table-column prop="name"  width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="单据应收金额" width="150">
									<el-table-column prop="name" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="name" label="已收款" width="110">
									<el-table-column prop="name" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="未收款" width="110">
									<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="收款说明" width="110">
									<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="拣货计划单号" width="150">
									<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="应收装载费" width="150">
									<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="应收配送司机费" width="180">
									<el-table-column prop="address" label="" width="180"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="应付转载费" width="150">
									<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="应付配送司机费" width="180">
									<el-table-column prop="address" label="" width="180"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="司机身份证号码" width="180">
									<el-table-column prop="address" label="" width="180"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								...
								<el-table-column prop="address" label="是否收现" width="110">
									<el-table-column prop="address" label="" width="110"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
								<el-table-column prop="address" label="商城支付方式" width="150">
									<el-table-column prop="address" label="" width="150"  class-name="mohucha">
								</el-table-column>
								</el-table-column>
						...
						<div id="table_ls">
							...
							<div class="table_right">
								<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="520" border style="width: 100%">
									...
									<el-table-column prop="address" label="辅助单价" width="110">
											<el-table-column prop="address" label="" width="110"  class-name="mohucha">
									</el-table-column>
									</el-table-column>
									...
									<el-table-column prop="address" label='明细源单号' width="150">
										<el-table-column prop="address" label='' width="150"  class-name="mohucha">
									</el-table-column>
									</el-table-column>
									<el-table-column prop="address" label="体积" width="110">
									...
									<el-table-column prop="address" label="商品条码" width="110">
										<el-table-column prop="address" label="" width="110"  class-name="mohucha">
									</el-table-column>
									</el-table-column>
									<el-table-column prop="address" label="收货地址" width="110">
									...
									<el-table-column prop="address" label="自定义3" width="110">
										<el-table-column prop="address" label="" width="110"  class-name="mohucha">
									</el-table-column>
									</el-table-column>
									<el-table-column prop="address" label="自定义4" width="110">
										<el-table-column prop="address" label="" width="110"  class-name="mohucha">
									</el-table-column>
									</el-table-column>
									...
									<el-table-column prop="address" label="子条码" width="110">
											<el-table-column prop="address" label="" width="110"  class-name="mohucha">
									</el-table-column>
									</el-table-column>
						...
						<div id='table_hz'>
							...
							<div class="table_right">
								<el-table :data="tableData3" @cell-dblclick="dbrow" @header-click="headerc" height="520" border style="width: 100%">
									...
									<el-table-column prop="name" label="部门" width="auto">
										<el-table-column prop="name" label="" width="auto"  class-name="mohucha">
									</el-table-column>
									</el-table-column>				
									...
									<el-table-column prop="address" label="单价" width="auto">
										<el-table-column prop="address" label="" width="auto"  class-name="mohucha">
									</el-table-column>
									</el-table-column>
