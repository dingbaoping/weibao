	...
	<div class="xspctjbb">
		...
		<div class="datatable">
			...
			<el-table :data="tableData4" border v-loading.body="loading" @cell-dblclick="dbrow" @header-click="headerc" element-loading-text="玩命加载中" style="width: 100%" height="550">
				...
				<el-table-column prop="JSDXMC" label="换算率" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="FXLX" label="基本单位" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="JFDJ" label="辅助单位" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="DJBH" label="单据数" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				<el-table-column prop="DJRQ" label="基本数量" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
				...
				<el-table-column prop="zip" label="单据数" width="110">
					<el-table-column  prop="CheckMark" label="" width="110" class-name="mohucha">
				</el-table-column>
				</el-table-column>
...
<style>
	.xspctjbb .el-form-item__content{
		line-height: 50px;
	}
	.xspctjbb button{
	...
	.xspctjbb .grid-content p{
		text-indent: 12px;
	}
	.xspctjbb .formcx{
		width: 100%;
	}
	.xspctjbb .el-icon-date{
		top: 12px;
	}
	.xspctjbb .buttondiv{
		margin-left: 30px;
