	...
	<div class="rkgl" style="position:relative">
			...
			<el-row :gutter="10">
				...
				<el-col :span="3">
					<div class="grid-content  ">
						<div  id="ckrq">
							<el-date-picker 
								class="input_width" v-model="ckrq" align="right" type="date"  disabled :picker-options="pickerOptions1">
							</el-date-picker>
						</div>
		...
		<el-col :span="3">
			...
			<div class='form-2'>
				...
				<el-form :inline="true" v-model="formInline" class="demo-form-inline">
					<el-form-item label="业务员" class='fl'>
						<el-input v-model="caigouyuan" disabled placeholder="" class='fr input_width button_w'></el-input>
					</el-form-item>
        ...
        var that = this;
			...
			getshopInfo(StorageID) {
          	...
          	that.saveData = data; //设置备份
						...
						that.xpssj = data[0].OutDate; // 出库日期
            that.shenheren = data[0].Checker; // 审核人
            that.shenherq = data[0].CheckDate; // 审核日期
            that.zhidanren = data[0].SalesMan; // 制单人
            that.caigouyuan = data[0].SalesMan; // 制单人
            that.CreationMethod = data[0].CreateWay; // 创建方式
